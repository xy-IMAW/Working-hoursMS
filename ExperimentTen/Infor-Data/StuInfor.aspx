        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" ShowBorder="false" ShowHeader="false"
                    ...
                    runat="server">                    
                   <Items>                                           
                       <f:Tree ID="Tree1" Width="150px" EnableCollapse="false"  Title="年级与班级" runat="server" Icon="Anchor" OnExpand="Tree1_Expand" OnNodeCommand="Tree1_NodeCommand" EnableTextSelection="true"> 
                       </f:Tree>                                        
                    </Items>
                </f:Region>
                                ...
                                <f:Toolbar ID="toolbar1" runat="server">
                                    <Items>
                                        ...
                                        <f:ContentPanel runat="server">
                                            <asp:Button ID="DownLoad" runat="server" Text="下载学生模板" OnClick="btnDownLoad_Click" />
                                        </f:ContentPanel>
